...
hl.env("XCURSOR_PATH", "/usr/share/icons:/home/$USER/.icons:/home/$USER/.local/share/icons")
...
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("grim -g \"$(slurp)\" ~/Pictures/Screenshots/screenshot.jpg"))
